									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<select name="service" class="form-control">
												...
												<option value="{{ $service->id }}" <?if($request->service == $service->id){?> selected <?}?>>{{ $service->title }}</option>
												@endforeach
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<select name="shop" class="form-control">
												...
												<option value="{{ $shop->id }}" <?if($request->shop == $shop->id){?> selected <?}?>>{{ $shop->name }}</option>
												@endforeach
											</select>
										</div>
									</div>
			                    	...
			                    	<div class="form-group">
										...
										<div class="col-md-8">
			                       			<select name="service_provider" value="0" class="form-control">
												...
												<option value="{{ $service_provider['id'] }}"<?if($request->service_provider == $service_provider['id']){?> selected <?}?>>{{ $service_provider['name'] }}</option>
												@endforeach
											</select>
			                    		</div>
			                    	</div>
